...
{
    internal class RealizationRelation : Relation
    {
        private Size PolygonSize { get; set; } = new Size(20, 20);

        public RealizationRelation(Block blockFrom, Block blockTo) : base(blockFrom, blockTo)
        {
        }
        ...
        public override void DrawRelation(Graphics g)
        {
            ...
            g.FillPath(new SolidBrush(Palette.BlockBackgroundColorActive(BlockFrom.Stereotype)), path);
            g.DrawPath(pen, path);
