...
{
    internal class CompositionRelation : Relation, ICardinal
    {
        ...
        public CompositionRelation(Block blockFrom, Block blockTo) : base(blockFrom, blockTo)
        {
        }
        ...
        public override void DrawRelation(Graphics g)
        {
            ...
            g.FillPath(new SolidBrush(Palette.PathColor), path);
